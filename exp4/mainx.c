...
int main()
{
    ...
    while ((p1 != NULL) || (p2 != NULL)) {
      ...
      //printf("p2 = (%d, %d)\n", (*p2).x, (*p2).y);
      if (p1 != NULL) {
        if(((*p1).x > 0) && (lab[(*p1).x - 1][(*p1).y] != 0) &&(aflag[(*p1).x -1][(*p1).y] == NULL)  ){
            node *tmp;
        ...
        if(((*p1).y > 0) && (lab[(*p1).x][(*p1).y - 1] != 0)&&(aflag[(*p1).x][(*p1).y -1] == NULL)  ){
            node *tmp;
            tmp = malloc(sizeof(struct node));
            (*a).next = tmp;
            a = tmp;
        ...
        if(((*p1).x < (n-1)) && (lab[(*p1).x + 1][(*p1).y] != 0)&& (aflag[(*p1).x + 1][(*p1).y] == NULL) ){
            node *tmp;
            tmp = malloc(sizeof(struct node));
            (*a).next = tmp;
            a = tmp;
        ...
        if(((*p1).y < (m - 1)) && (lab[(*p1).x][(*p1).y + 1] != 0) && (aflag[(*p1).x][(*p1).y + 1] == NULL) ){
            node *tmp;
            tmp = malloc(sizeof(struct node));
            (*a).next = tmp;
            a = tmp;
       ...
       if (p2 != NULL) {
        if(((*p2).x > 0) && (lab[(*p2).x - 1][(*p2).y] != 0) && (bflag[(*p2).x - 1][(*p2).y] == NULL) ){
            node *tmp;
            tmp = malloc(sizeof(struct node));
            (*b).next = tmp;
            b = tmp;
        ...
        if(((*p2).y > 0) && (lab[(*p2).x][(*p2).y - 1] != 0) && (bflag[(*p2).x][(*p2).y - 1] == NULL) ){
            node *tmp;
            tmp = malloc(sizeof(struct node));
            (*b).next = tmp;
            b = tmp;
        ...
        if(((*p2).x < (n-1)) && (lab[(*p2).x + 1][(*p2).y] != 0) &&(bflag[(*p2).x + 1][(*p2).y] == NULL)  ){
            node *tmp;
            tmp = malloc(sizeof(struct node));
            (*b).next = tmp;
            b = tmp;
        ...
        if(((*p2).y < (m - 1)) && (lab[(*p2).x][(*p2).y + 1] != 0) && (bflag[(*p2).x][(*p2).y + 1] == NULL) ){
            node *tmp;
            tmp = malloc(sizeof(struct node));
            (*b).next = tmp;
            b = tmp;
